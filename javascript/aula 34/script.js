...
//body_id.setAttribute('onkeyDown', 'teclado(event)')
// O metodo acima nao e muito recomendado, sendo o correto utilizar o addEventListener

body_id.addEventListener('click',alertar)
// Pode ate fazer com funcao anonima / arrow function
//body_id.addEventListener('click',function (){ alert('clicou tbm')})

// Posso chamar com keydown, ou qualquer outro evento e assim, por diante
